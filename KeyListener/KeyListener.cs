...
namespace com.jarvisniu.utils
{
    public class KeyListener
    {
        ...
        private List<string> systemShortcuts = new List<string> { 
            "CTRL + C",
            "CTRL + V",
            "CTRL + X"
        };
        ...
        public KeyListener onShortcutRemove(string keyString)
        {
            watchCombinedKey(keyString);
            pressActions.Remove(keyString);
            return this;
        }

        public bool isSystemShortcutCollision(string keyString)
        {
            return systemShortcuts.Contains(keyString);
        }
